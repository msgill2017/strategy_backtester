...
from strategy_backtester.portfolio_balance import previous_orders_from_trade_book
...
if already_trade_days:
    ...
    previous_orders = previous_orders_from_trade_book(trade_book, option_chain_df, previous_day)
